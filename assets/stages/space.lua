function onCreate()
	-- background shit
	makeLuaSprite('spaceback', 'spaceback', -500, -300);
	setLuaSpriteScrollFactor('spaceback', 0.9, 0.9);
	
	makeLuaSprite('spacefront', 'spacefront', -650, 600);
	setLuaSpriteScrollFactor('spacefront', 0.9, 0.9);
	scaleObject('spacefront', 1.1, 1.1);
