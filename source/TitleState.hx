...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		// add(gfDance); -- REMOVED BY Amonymus
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('Trani_logo'));
		add(ngSpr);
		ngSpr.visible = false;
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['Psych Engine HaxeFlixel'], 15);
					#else
					createCoolText(['Fl studio 20']);
					#end
				// credTextShit.visible = true;
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('va', 10);
					addMoreText('prezinta', 15);
					addMoreText('acum', 15);
					#else
					addMoreText('in premiera');
					#end
				// credTextShit.text += '\nprezinta...';
				...
				case 5:
					deleteCoolText();
				// credTextShit.visible = false;
				// credTextShit.text = 'Pentru concursul';
				// credTextShit.screenCenter();
				case 6:
					#if PSYCH_WATERMARKS
					createCoolText(['Pentru concursul', 'minunat'], -40);
					#else
					createCoolText(['Pentru concursul', 'minunat'], -40);
					#end
				case 8:
					addMoreText('InfoEducatie', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nInfoEducatie';
				case 9:
					deleteCoolText();
				...
				// credTextShit.text += '\nNight';
				case 16:
					addMoreText('spatiu'); // credTextShit.text += '\nFunkin';
